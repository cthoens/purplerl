# The exact resnet code from tochvision with a tiny modification to
# support single channel images
#
# Origin: https://github.com/pytorch/vision/blob/main/torchvision/models/resnet.py
...
class ResNet(nn.Module):
    def __init__(
        ...
        self.layer3 = self._make_layer(block, 126, layers[2], stride=2, dilate=replace_stride_with_dilation[1])
