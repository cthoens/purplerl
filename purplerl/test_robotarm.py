...
if __name__ == '__main__':
    ...
    env_manager = RobotArmEnvManager(file_name=file_name, action_scaling=2.0)
    ...
    checkpoint = torch.load("results/RobotArm/phase1/true-serenity-139/checkpoint450.pt", map_location=cfg.device)
